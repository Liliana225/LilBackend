...
@allure.description("Этот тест проверяет корректность работы метода post и кодов ответа")
def test_sign_up1():
    code = 200
...
@allure.description("Этот тест проверяет корректность работы метода post, get и кодов ответа")
